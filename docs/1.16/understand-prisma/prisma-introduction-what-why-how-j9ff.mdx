...
Prisma is the _data layer_ in your application architecture. Concretely, this means Prisma consists of a number of tools simplifying database access in the application you build. 

Prisma replaces traditional ORMs and provides a powerful way to work with databases.

Here is an overview of the main components of Prisma:

- **Prisma server**: A proxy server for your database hosting _Prisma Services_.
- **Prisma service**: Maps a Prisma [data model](knul) to your database and lets you read and write to the database using GraphQL. 
- **Prisma client**: Connects to your Prisma service and replaces a traditional ORM in your application architecure (available in various languages).
- **Prisma Admin** (_coming soon_): A GUI-based application that lets you view and modify the data in your database.
...
1. Stream database events in realtime.
...
- **Backend development**: No matter if you're building a GraphQL or a REST API for your application server, Prisma
