...
The Prisma CLI integrates with [`graphql-config`](https://github.com/prisma/graphql-config). If your project uses a `.graphqlconfig`-file, you can use the `prisma` extension and point it to your prisma.yml:
