...
You now need to introspect your database schema to generate the datamodel for your Prisma service:
...
This service configuration now needs to be _deployed_ so you can use the Prisma API of your service. Run the following command (this does **not** change anything in your database):
...
If you don't have such a `User` type, feel free to adjust the following code snippets with a type that matches your datamodel.
