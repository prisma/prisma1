...
The [Prisma CLI](https://www.npmjs.com/package/prisma) is used to deploy and manage Prisma Services. You can install it using [Homwbrew](https://brew.sh/) or [NPM](https://www.npmjs.com/):
