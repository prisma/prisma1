...
To bootstrap the service configuration files for your first Prisma service, create a new directory and initalize it using the `prisma1 init` command:
...
The `prisma1 init` command created the _minimal_ service configuration needed to deploy a Prisma service: `prisma.yml` and `datamodel.graphql`. 
