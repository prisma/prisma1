...
- `datamodel.prisma`: Specifies the datamodel for your application that will be mapped to the database.
...
The `prisma init` command created the _minimal_ Service configuration needed to deploy a Prisma service: `prisma.yml` and `datamodel.prisma`. This Service configuration now needs to be _deployed_ so you can use the Prisma API of your Service:
