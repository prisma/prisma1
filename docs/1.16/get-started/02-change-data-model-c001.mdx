...
- Change the datamodel of your Prisma service
- Deploy the adjusted datamodel to update your Prisma API
...
To apply the changes you just made to your datamodel, you need to redeploy your Prisma service:
...
The Prisma client in `prisma.js` is now being updated and has been adjusted to your new datamodel.
