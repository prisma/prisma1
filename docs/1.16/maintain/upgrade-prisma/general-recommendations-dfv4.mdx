...
If you have any questions about upgrading your Prisma server, feel free to reach out in [the Forum](https://graph.cool/forum), [Slack](https://slack.graph.cool) or [Github](https://github.com/prismagraphql/prisma).

## Release notes

Read through all the [release notes](https://github.com/prismagraphql/prisma/releases) for the versions between your current one and the target version you want to upgrade to. Consider which changes affect you and your project. If you are not sure about the implications of a certain change, feel free to ask for clarification as mentioned above.
