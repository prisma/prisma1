...
*The next step is to connect the app with your GraphQL API. Copy the `Simple API` endpoint to `./src/main.js` as the `uri` argument in the `createNetworkInterface` call:*
