...
The `prisma1 introspect` can currently not be used to suggest a datamodel. Leave a +1 on [this](https://github.com/prisma/prisma/issues/3529) feature request if you're interested in this functionality.
