...
> Learn more in twhe [specification](https://github.com/prisma/prisma/issues/3403).
...
This first creates a new document in the `User` collection and then retrieves all the documents from the `User` collection.
