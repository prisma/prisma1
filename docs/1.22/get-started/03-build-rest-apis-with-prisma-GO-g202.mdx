...
This tutorial is currently being worked on and will be published soon. In the meantime you can check out our [REST API example for Go](https://github.com/prisma/prisma1-examples/tree/master/go-gin).