...
To automate this process, you can use the [`prisma introspect`](xcv9#prisma-introspect) command from the [Prisma CLI](alx4) to generate the [datamodel](soi3) based on the actual structure of the existing data.
...
To be able to query your Postgres MongoDB using Prisma you now need to _deploy_ the service and open a GraphQL Playground:
