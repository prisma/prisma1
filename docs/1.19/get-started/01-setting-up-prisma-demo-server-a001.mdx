...
- `generated/prisma-client/`: Contains the auto-generated Prisma client library.
...
Add the following code to `index.js` and save it afterwards:
...
Feel free to play around with the Prisma client API and try out more operations by adding the following code snippets to the file (at the end of the `main` function) and re-executing the script:
