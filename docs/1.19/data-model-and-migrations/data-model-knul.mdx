...
You can generate the Prisma GraphQL schema using the [`generate`](5cy7#generate-optional) property in prisma.yml. Learn more [here](rsc1#configuring-generate-in-prisma.yml).
