...
The [MongoDB](jgfm) database connector currently does not support transactions. Learn more in [this](https://github.com/prisma/prisma/issues/3738) GitHub issue.
...
fc261a149740        prismagraphql/prisma:1.23    "/bin/sh -c /app/sta…"   About a minute ago   Up About a minute   0.0.0.0:4466->4466/tcp     hello-mongo_prisma_1
```
