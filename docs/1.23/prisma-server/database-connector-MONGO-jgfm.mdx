...
A database connector is the bridge between Prisma and the underlying database. The MongoDB connector is used to connect a Prisma server to a [MongoDB](https://www.mongodb.com) database. 
