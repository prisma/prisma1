...
It's currently not possible to order responses [by multiple fields](https://github.com/prisma/feature-requests/issues/62) or [by related fields](https://github.com/prisma/feature-requests/issues/95). Join the discussion in the feature requests if you're interested in these features!
...
Currently, neither [**scalar list filters**](https://github.com/prisma/feature-requests/issues/60) nor [**JSON filters**](https://github.com/prisma/feature-requests/issues/148) are available. Join the discussion in the respective feature requests on GitHub.
