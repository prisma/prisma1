...
> In the future, it is planned to extend server-side subscriptions to directly stream events into various event targets, such as AWS Kinesis, Kafka, etc. Join the discussion on [GitHub](https://github.com/prismagraphql/prisma/issues/585) to learn more.
