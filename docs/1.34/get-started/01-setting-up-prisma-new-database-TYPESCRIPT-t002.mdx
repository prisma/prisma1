...
The best way to get started is by following the step-by-step [tutorial](https://github.com/prisma/prisma2/blob/master/docs/tutorial.md) or exploring the ready-to-run [examples](https://github.com/prisma/prisma-examples/tree/prisma2). Note that the Prisma Framework is not production-ready yet, you can track its development on [isprisma2ready.com](https://isprisma2ready.com).
