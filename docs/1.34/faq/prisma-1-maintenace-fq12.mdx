...
If you plan to [upgrade to Prisma ORM](https://www.prisma.io/docs/guides/upgrade-guides/upgrade-from-prisma-1/how-to-upgrade) please [email us](prisma1cloud@prisma.io) for a native export of your databases.
