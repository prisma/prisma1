...
To bootstrap the configuration files for your Prisma set up, create a new directory and initalize it using the `prisma init` command:
...
1. Select **Prisma Flow Client** to generate Prisma client for Node.js with Flow.
...
Run the following command to create an empty script:
