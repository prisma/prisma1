...
This tutorial is currently being worked on and will be published soon. In the meantime you can check out our [GraphQL server example for Go](https://github.com/prisma/prisma1-examples) or learn more building type-safe GraphQL servers using Go [here](https://gqlgen.com/getting-started/).