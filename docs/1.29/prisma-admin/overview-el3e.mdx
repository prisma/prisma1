...
You can read the announcement blog post for Prisma Admin [here](https://www.prisma.io/blog/prisma-admin-beta-pai5lah43soe/).
...
Once you are running the `1.30-beta`-version of Prisma, Prisma Admin is accessible at the `/_admin` endpoint of your Prisma service: `https://__PRISMA_SERVER__/__SERVICE_NAME/__SERVICE_STAGE__/_admin`
