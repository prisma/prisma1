...
If you want to view and edit the data in your database, you can use [Prisma Admin](https://www.prisma.io/blog/prisma-admin-beta-pai5lah43soe/). To access Prisma Admin, you need to append `/_admin` to your Prisma endpoint, for example: `https://eu1.prisma.sh/alice/helloworld/dev/_admin`.
