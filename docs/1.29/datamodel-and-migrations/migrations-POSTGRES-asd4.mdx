...
When migrations are disabled, you need to manually ensure that your datamodel is in sync with the underlying database schema, otherwise the Prisma API might exhibit undefined behaviour! 
