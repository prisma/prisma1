...
> **Note**: This tutorial only covers the basics of using Graphcool. To learn how to use Graphcool with a specific framework or programming language (like React, TypeScript or Node.js), please refer to the other quickstart tutorials.
