...
This page is only relevant if you started with a [new database](a002) or a [demo server](j001). If you configured Prisma with an [existing database](a003), you need to run migrations directly against your database.
