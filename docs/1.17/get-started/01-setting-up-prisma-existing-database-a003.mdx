...
```yml copy
# Coming soon. See https://github.com/prisma/prisma/issues/1230
```
...
The CLI now stored your Prisma client inside the `prisma-client` folder as specified in `prisma.yml`.
