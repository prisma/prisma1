...
1. Choose the suggested values for the following questions:
  1. **Region** where Prisma service should be hosted
  1. **Name** for Prisma service
  1. **Stage** for Prisma service
1. Select **Prisma JavaScript Client** to generate Prisma client for Node
