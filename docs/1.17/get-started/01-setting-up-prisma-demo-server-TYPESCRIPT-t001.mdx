...
1. Select **Prisma TypeScript Client** to generate Prisma client for Node.js with TypeScript.
...
Finally, add a script to your `package.json` to execute the script:
