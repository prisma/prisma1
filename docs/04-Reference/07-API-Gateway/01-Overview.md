...
[Here](https://github.com/graphcool/graphcool/tree/master/examples/gateway-custom-schema) is an example that demonstrates how to implement a simple API gateway on top of a Graphcool service, using node.js and express.
