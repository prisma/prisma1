...
> Snapshot 1
    ...
    ␊
            var UserPreviousValuesFields = []string{"id", "email", "password", "name"}␊
    ␊
    ...
    ␊
            var UserFields = []string{"id", "email", "password", "name"}␊
    ␊
            type User struct {␊
              ID string `json:"id"`␊
    Email string `json:"email"`␊
    ...
    ␊
            var PostFields = []string{"id", "isPublished", "title", "text"}␊
    ␊
            type Post struct {␊
              ID string `json:"id"`␊
    IsPublished bool `json:"isPublished"`␊
    ...
    ␊
            var PostPreviousValuesFields = []string{"id", "isPublished", "title", "text"}␊
    ␊
