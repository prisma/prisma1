...
> Snapshot 1
    ...
    ␊
       ...
       */␊
    ␊
      usersConnection: (where?: UserWhereInput) => UserConnectionNullablePromise;␊
      housesConnection: (where?: HouseWhereInput) => HouseConnectionNullablePromise;␊
    ␊
      /**␊
       * Mutations␊
       */␊
    ...
    ␊
    export interface AggregateHouseNullablePromise␊
      extends Promise<AggregateHouse | null>,␊
        Fragmentable {␊
      count: () => Promise<Int>;␊
    }␊
    ␊
    ...
    ␊
    export interface HouseEdgeNullablePromise␊
      extends Promise<HouseEdge | null>,␊
        Fragmentable {␊
      node: <T = HousePromise>() => T;␊
      cursor: () => Promise<String>;␊
    }␊
    ...
    ␊
    export interface HouseConnectionNullablePromise␊
      extends Promise<HouseConnection | null>,␊
        Fragmentable {␊
      pageInfo: <T = PageInfoPromise>() => T;␊
      edges: <T = FragmentableArray<HouseEdge>>() => T;␊
      aggregate: <T = AggregateHousePromise>() => T;␊
