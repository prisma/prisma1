...
//   static topic = 'login'
//   static description = 'Login or signup to the Prisma Platform'
//   static group = 'platform'
//   static help = `

//   Note: Your session token will be store at ~/.prisma

//   ${chalk.green('Examples:')}

//   ${chalk.gray('-')} Authenticate using the browser
//     ${chalk.green('$ prisma login')}

//   ${chalk.gray('-')} Authenticate using an existing token
//     ${chalk.green('$ prisma login -t <token>')}
