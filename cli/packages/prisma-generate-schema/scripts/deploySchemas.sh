...
do
    ...
    prisma deploy
    ~/code/prisma/cli/packages/prisma-cli/dist/index.js introspect --sdl --prototype > "${dir}/model_${1}_v1.1.graphql" #--mongo-uri mongodb://prisma:prisma@localhost:27017/admin --mongo-db "schema-generator_$model"
done
