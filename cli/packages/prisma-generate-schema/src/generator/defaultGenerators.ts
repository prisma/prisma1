...
export default class Generators implements IGenerators {
  ...
  modelCreateOneInput = new ModelCreateOneInputGenerator(this.typeRegistry, this)
  modelCreateManyInput = new ModelCreateManyInputGenerator(this.typeRegistry, this)
  modelCreateWithoutRelatedInput = new ModelCreateWithoutRelatedInputGenerator(this.typeRegistry, this)
  modelCreateOneWithoutRelatedInput = new ModelCreateOneWithoutRelatedInputGenerator(this.typeRegistry, this)
  modelCreateManyWithoutRelatedInput = new ModelCreateManyWithoutRelatedInputGenerator(this.typeRegistry, this)
  ...
  modelUpsertNestedInput = new ModelUpsertNestedInputGenerator(this.typeRegistry, this)
  modelUpsertWithWhereUniqueWithoutRelatedInput = new ModelUpsertWithWhereUniqueWithoutRelatedInputGenerator(this.typeRegistry, this)
  modelUpsertWithoutRelatedInput = new ModelUpsertWithoutRelatedInputGenerator(this.typeRegistry, this)
  modelUpsertWithWhereUniqueNestedInput = new ModelUpsertWithWhereUniqueNestedInputGenerator(this.typeRegistry, this)

  modelWhereUniqueInput = new ModelWhereUniqueInputGenerator(this.typeRegistry, this)
  ...
  uniqueQueryArguments = new UniqueQueryArgumentsGenerator(this.typeRegistry, this)
  node = new NodeGenerator(this.typeRegistry, this)

  batchPayload = new BatchPayloadGenerator(this.typeRegistry, this)

  modelSubscriptionPayload = new ModelSubscriptionPayloadGenerator(this.typeRegistry, this)
  ...
  modelPreviousValues = new ModelPreviousValuesGenerator(this.typeRegistry, this)
