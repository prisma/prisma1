...
export default class ModelUpdateManyWithWhereNestedInputGenerator extends RelatedModelInputObjectTypeGenerator {
  ...
  protected generateFields(model: IGQLType, args: RelatedGeneratorArgs) {
    ...
    fields.where = { type: new GraphQLNonNull(this.generators.modelScalarWhereInput.generate(model, {})) }
    fields.data = { type: new GraphQLNonNull(this.generators.modelUpdateManyDataInput.generate(model, {})) }
