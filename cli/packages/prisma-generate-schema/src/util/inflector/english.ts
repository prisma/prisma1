...
export class English extends TwoFormInflector {
  ...
  private static CATEGORY_UM_A = ["bacterium",
    "agendum", "desideratum", "erratum", "stratum", "datum", "ovum",
    "extremum", "candelabrum"]
  private static CATEGORY_US_I = ["alumnus", "alveolus",
    "bacillus", "bronchus", "locus", "nucleus", "stimulus", "meniscus",
    "thesaurus"]
  private static CATEGORY_ON_A = ["criterion",
    "perihelion", "aphelion", "phenomenon", "prolegomenon", "noumenon",
    "organon", "asyndeton", "hyperbaton"]
  private static CATEGORY_A_AE = ["alumna", "alga",
    "vertebra", "persona"]
  private static CATEGORY_O_OS = ["albino",
  ...
  private static CATEGORY_A_ATA = ["anathema", "enema", "oedema", "bema", "enigma", "sarcoma",
  ...
  private static CATEGORY_US_US = ["apparatus", "impetus", "prospectus", "cantus", "nexus", "sinus", "coitus",
    "plexus", "status", "hiatus"]
  private static CATEGORY_NONE_I = ["afreet", "afrit", "efreet"]
  private static CATEGORY_NONE_IM = ["cherub", "goy", "seraph"]
  private static CATEGORY_EX_EXES = ["apex", "latex", "vertex", "cortex", "pontifex", "vortex", "index", "simplex"]
  private static CATEGORY_IX_IXES = ["appendix"]
  private static CATEGORY_S_ES = ["acropolis", "chaos", "lens", "aegis",
    ...
    "canvas", "ibis", "trellis"]
  private static CATEGORY_MAN_MANS = ["human", "Alabaman", "Bahaman", "Burman", "German", "Hiroshiman", "Liman", "Nakayaman", "Oklahoman",
  ...
  constructor(mode: Mode = Mode.ENGLISH_ANGLICIZED) {
    ...
    if (mode === Mode.ENGLISH_ANGLICIZED) {
      ...
      // Classical plural
      super.irregularFromList([["beef", "beeves"],
      ["brother", "brethren"],
