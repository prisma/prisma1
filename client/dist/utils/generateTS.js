...
var codeComment_1 = require("./codeComment");
...
exports.TestTypescriptGenerator = TestTypescriptGenerator;
function generateTypescript(schemaString) {
    return __awaiter(this, void 0, void 0, function () {
        var schema, generator, output, code, typeDefs;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    schema = graphql_1.buildSchema(schemaString);
                    generator = new TestTypescriptGenerator({ schema: schema, internalTypes: [] });
                    output = path.join(__dirname, '..', 'artifacts', 'generated', 'prisma-client');
                    code = generator.render();
                    return [4 /*yield*/, fs.writeFileSync(path.join(output, 'index.ts'), code)];
                case 1:
                    _a.sent();
                    typeDefs = generator.renderTypedefs();
                    return [4 /*yield*/, fs.writeFileSync(path.join(output, 'prisma-schema.ts'), typeDefs)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
