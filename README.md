...
> **Note**: Prisma 1 is currently in [maintenance mode](https://github.com/prisma/prisma1/issues/4898). If you are new to Prisma, we recommend to [use Prisma 2](https://www.prisma.io) instead.
