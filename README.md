...
**Prisma the data layer for modern applications**. It replaces traditional ORMs and data access layers with a universal database abstraction used via the Prisma client. Prisma can be used to build **GraphQL servers, REST APIs & more**. 
