...
> Snapshot 1
    ...
    ␊
    export interface Mutation     createPost: (args: { data: PostCreateInput }) => Post;␊
    ...
    ␊
    export interface Subscription     post: <T = Promise<Partial<PostSubscriptionPayloadNode | null>>>(args?: { where?: PostSubscriptionWhereInput , info?: GraphQLResolveInfo, options?: Options}) => Promise<AsyncIterator<T>>;␊
    ...
    ␊
    export interface DelegateMutation     createPost: <T = Promise<Partial<PostNode>>>(args: { data: PostCreateInput , info?: GraphQLResolveInfo, options?: Options}) => T;␊
