# Snapshot report for `dist/codegen/TypescriptDefinitionGenerator.test.js`
...
> Snapshot 1
    ...
    ␊
    export interface Query     posts: (args?: { where?: PostWhereInput, orderBy?: PostOrderByInput, skip?: Int, after?: String, before?: String, first?: Int, last?: Int }) => Promise<Array<PostNode>>;␊
    ...
    ␊
    export interface Mutation     createPost: (data: PostCreateInput) => Post;␊
    ...
    ␊
    export interface Subscription     post: <T = Promise<Partial<PostSubscriptionPayloadNode | null>>>(where?: PostSubscriptionWhereInput) => Promise<AsyncIterator<T>>;␊
    ...
    ␊
    export interface DelegateQuery     posts: <T = Promise<Array<PostNode>>>(args?: { where?: PostWhereInput, orderBy?: PostOrderByInput, skip?: Int, after?: String, before?: String, first?: Int, last?: Int , info?: GraphQLResolveInfo, options?: Options}) => T;␊
    ...
    ␊
    export interface DelegateMutation     createPost: <T = Promise<Partial<PostNode>>>(where: PostCreateInput) => T;␊
