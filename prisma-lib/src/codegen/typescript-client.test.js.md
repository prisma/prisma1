...
> Snapshot 1
    ...
    */␊
    ...
    export interface PostConnection extends Promise<PostConnectionNode> {␊
      ...
      edges: <P = Promise<Array<PostEdgeNode>>> () => P␊
    ...
    export interface User extends Promise<UserNode>, Node {␊
      ...
      password: () => Promise<String>␊
      name: () => Promise<String>␊
      posts: <P = Promise<Array<PostNode>>> (args?: { where?: PostWhereInput, orderBy?: PostOrderByInput, skip?: Int, after?: String, before?: String, first?: Int, last?: Int }, fragment: string | object) => P␊
          }␊
    ␊
