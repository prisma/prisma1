...
> Snapshot 1
    ...
    ␊
        ...
        post: <T = Post>(where: PostWhereUniqueInput) => T;␊
    ...
    ␊
      ...
      */␊
    ␊
        createPost: <T = Post>(data: PostCreateInput) => T;␊
        ...
        deletePost: <T = Post>(where: PostWhereUniqueInput) => T;␊
        ...
        deleteManyPosts: <T = BatchPayload>(where: PostWhereInput) => T;␊
    ...
    export interface Subscription {␊
        post: <T = PostSubscriptionPayload>(where?: PostSubscriptionWhereInput) => Promise<AsyncIterator<T>>;␊
    ...
    export interface DelegateSubcription {␊
        post: <T = Promise<Partial<PostSubscriptionPayloadNode | null>>>(where?: PostSubscriptionWhereInput) => Promise<AsyncIterator<T>>;␊
    ...
    */␊
    ...
    ␊
     */␊
    export interface PostConnection extends Promise<PostConnectionNode>, Promise<AsyncIterator<PostConnectionNode>> {␊
    ...
    ␊
    export interface Post extends Promise<PostNode>, Promise<AsyncIterator<PostNode>>, Node {␊
            id: () => Promise<ID_Output>␊
    ...
    ␊
    export interface PostSubscriptionPayload extends Promise<PostSubscriptionPayloadNode>, Promise<AsyncIterator<PostSubscriptionPayloadNode>> {␊
    ...
    ␊
    export interface PostPreviousValues extends Promise<PostPreviousValuesNode>, Promise<AsyncIterator<PostPreviousValuesNode>> {␊
            id: () => Promise<ID_Output>␊
      createdAt: () => Promise<DateTimeOutput>␊
      updatedAt: () => Promise<DateTimeOutput>␊
      isPublished: () => Promise<Boolean>␊
    ...
    ␊
     */␊
    export interface PostEdge extends Promise<PostEdgeNode>, Promise<AsyncIterator<PostEdgeNode>> {␊
            node: <T = Post>() => T␊
      cursor: () => Promise<String>␊
          }␊
    ␊
    ...
    ␊
    export interface AggregatePost extends Promise<AggregatePostNode>, Promise<AsyncIterator<AggregatePostNode>> {␊
            count: () => Promise<Int>␊
          }␊
    ␊
    /*␊
