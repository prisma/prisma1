...
> Snapshot 1
    ...
    export interface Subscription {␊
        post: <T = PostSubscriptionPayload>(where?: PostSubscriptionWhereInput, fragment?: string | object) => T;␊
    ...
    export interface DelegateSubscription {␊
        post: <T = Promise<Partial<PostSubscriptionPayloadNode | null>>>(where?: PostSubscriptionWhereInput, fragment?: string | object) => T;␊
    ...
    */␊
    ...
    ␊
     */␊
    export interface PostConnection extends Promise<PostConnectionNode | AsyncIterator<PostConnectionNode>> {␊
    ...
    ␊
    export interface Post extends Promise<PostNode | AsyncIterator<PostNode>>, Node {␊
            id: () => Promise<ID_Output>␊
    ...
    ␊
    export interface PostSubscriptionPayload extends Promise<PostSubscriptionPayloadNode | AsyncIterator<PostSubscriptionPayloadNode>> {␊
    ...
    ␊
    export interface PostPreviousValues extends Promise<PostPreviousValuesNode | AsyncIterator<PostPreviousValuesNode>> {␊
            id: () => Promise<ID_Output>␊
      createdAt: () => Promise<DateTimeOutput>␊
      updatedAt: () => Promise<DateTimeOutput>␊
      isPublished: () => Promise<Boolean>␊
    ...
    ␊
     */␊
    export interface PostEdge extends Promise<PostEdgeNode | AsyncIterator<PostEdgeNode>> {␊
            node: <T = Post>() => T␊
      cursor: () => Promise<String>␊
          }␊
    ␊
    ...
    ␊
    export interface AggregatePost extends Promise<AggregatePostNode | AsyncIterator<AggregatePostNode>> {␊
            count: () => Promise<Int>␊
          }␊
    ␊
    /*␊
