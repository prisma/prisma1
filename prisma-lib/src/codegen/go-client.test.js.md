...
> Snapshot 1
    ...
    ␊
          ␊
              ␊
              type struct PostsParams {␊
                where *PostWhereInput,orderBy *PostOrderByInput,skip *int32,after *string,before *string,first *int32,last *int32␊
              ␊
              ␊
              // Posts docs - executable for types␊
            func (instance *UserExec) Posts(params *PostsParams) *PostExec {␊
                  var args []GraphQLArg␊
                  args = append(args, GraphQLArg{␊
                    Name: "where",␊
                    Key: "where",␊
