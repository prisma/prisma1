...
> Snapshot 1
    ...
    Last int32␊
              ...
              data := db.Request(`query Q ($where: PostWhereInput, $orderBy: PostOrderByInput, $skip: Int, $after: String, $before: String, $first: Int, $last: Int) {␊
            posts (where: $where,␊
    orderBy: $orderBy,␊
    skip: $skip,␊
    after: $after,␊
    ...
    Last int32␊
              ...
              data := db.Request(`query Q ($where: UserWhereInput, $orderBy: UserOrderByInput, $skip: Int, $after: String, $before: String, $first: Int, $last: Int) {␊
            users (where: $where,␊
    orderBy: $orderBy,␊
    skip: $skip,␊
    after: $after,␊
