...
> Snapshot 1
    ...
    Last int32 `json:"last"`␊
              ...
              ␊
              // Posts docs␊
              func (db DB) Posts (params PostsParams) PostsExec {␊
              data := db.Request(`query Posts ($where: PostWhereInput, $orderBy: PostOrderByInput, $skip: Int, $after: String, $before: String, $first: Int, $last: Int) {␊
            posts (where: $where,␊
    orderBy: $orderBy,␊
    skip: $skip,␊
    after: $after,␊
    ...
    Last int32 `json:"last"`␊
              ...
              ␊
              // Users docs␊
              func (db DB) Users (params UsersParams) UsersExec {␊
              data := db.Request(`query Users ($where: UserWhereInput, $orderBy: UserOrderByInput, $skip: Int, $after: String, $before: String, $first: Int, $last: Int) {␊
            users (where: $where,␊
    orderBy: $orderBy,␊
    skip: $skip,␊
    after: $after,␊
    ...
    ␊
              ...
              data := db.Request(`query Post ($where: PostWhereUniqueInput) {␊
            post (where: $where) {␊
                id␊
    createdAt␊
    updatedAt␊
    ...
    ␊
              ...
              data := db.Request(`query User ($where: UserWhereUniqueInput) {␊
            user (where: $where) {␊
                id␊
    email␊
    password␊
    ...
    Last int32 `json:"last"`␊
              ...
              func (db DB) PostsConnection (params PostsConnectionParams) PostsConnectionExec {␊
              data := db.Request(`query PostsConnection ($where: PostWhereInput, $orderBy: PostOrderByInput, $skip: Int, $after: String, $before: String, $first: Int, $last: Int) {␊
    ...
    Last int32 `json:"last"`␊
              ...
              func (db DB) UsersConnection (params UsersConnectionParams) UsersConnectionExec {␊
              data := db.Request(`query UsersConnection ($where: UserWhereInput, $orderBy: UserOrderByInput, $skip: Int, $after: String, $before: String, $first: Int, $last: Int) {␊
    ...
    ␊
              ...
              data := db.Request(`query Node ($id: ID) {␊
            node (id: $id) {␊
                ␊
            }␊
        }`,␊
    ...
    ␊
          ␊
                  ...
                  ␊
                  // CreatePost docs␊
                  func (db DB) CreatePost (params CreatePostParams) CreatePostExec {␊
                  data := db.Request(`mutation CreatePost ($data: PostCreateInput) {␊
    ...
    ␊
                  ...
                  ␊
                  // CreateUser docs␊
                  func (db DB) CreateUser (params CreateUserParams) CreateUserExec {␊
                  data := db.Request(`mutation CreateUser ($data: UserCreateInput) {␊
    ...
    Where PostWhereUniqueInput `json:"where"`␊
                  ...
                  ␊
                  // UpdatePost docs␊
                  func (db DB) UpdatePost (params UpdatePostParams) UpdatePostExec {␊
                  data := db.Request(`mutation UpdatePost ($data: PostUpdateInput, $where: PostWhereUniqueInput) {␊
    ...
    Where UserWhereUniqueInput `json:"where"`␊
                  ...
                  ␊
                  // UpdateUser docs␊
                  func (db DB) UpdateUser (params UpdateUserParams) UpdateUserExec {␊
                  data := db.Request(`mutation UpdateUser ($data: UserUpdateInput, $where: UserWhereUniqueInput) {␊
    ...
    ␊
                  ...
                  ␊
                  // DeletePost docs␊
                  func (db DB) DeletePost (params DeletePostParams) DeletePostExec {␊
                  data := db.Request(`mutation DeletePost ($where: PostWhereUniqueInput) {␊
    ...
    ␊
                  ...
                  ␊
                  // DeleteUser docs␊
                  func (db DB) DeleteUser (params DeleteUserParams) DeleteUserExec {␊
                  data := db.Request(`mutation DeleteUser ($where: UserWhereUniqueInput) {␊
    ...
    Update PostUpdateInput `json:"update"`␊
                  ...
                  ␊
                  // UpsertPost docs␊
                  func (db DB) UpsertPost (params UpsertPostParams) UpsertPostExec {␊
                  data := db.Request(`mutation UpsertPost ($where: PostWhereUniqueInput, $create: PostCreateInput, $update: PostUpdateInput) {␊
    ...
    Update UserUpdateInput `json:"update"`␊
                  ...
                  ␊
                  // UpsertUser docs␊
                  func (db DB) UpsertUser (params UpsertUserParams) UpsertUserExec {␊
                  data := db.Request(`mutation UpsertUser ($where: UserWhereUniqueInput, $create: UserCreateInput, $update: UserUpdateInput) {␊
    ...
    Where PostWhereInput `json:"where"`␊
                  ...
                  func (db DB) UpdateManyPosts (params UpdateManyPostsParams) UpdateManyPostsExec {␊
                  data := db.Request(`mutation UpdateManyPosts ($data: PostUpdateInput, $where: PostWhereInput) {␊
    ...
    Where UserWhereInput `json:"where"`␊
                  ...
                  func (db DB) UpdateManyUsers (params UpdateManyUsersParams) UpdateManyUsersExec {␊
                  data := db.Request(`mutation UpdateManyUsers ($data: UserUpdateInput, $where: UserWhereInput) {␊
    ...
    ␊
                  ...
                  func (db DB) DeleteManyPosts (params DeleteManyPostsParams) DeleteManyPostsExec {␊
                  data := db.Request(`mutation DeleteManyPosts ($where: PostWhereInput) {␊
    ...
    ␊
                  ...
                  func (db DB) DeleteManyUsers (params DeleteManyUsersParams) DeleteManyUsersExec {␊
                  data := db.Request(`mutation DeleteManyUsers ($where: UserWhereInput) {␊
