...
//
//import cool.graph.api.database.Types.Id
...
//
//abstract class DataResolver(val project: Project) extends Cloneable {
//
...
//  def masterClientDatabase: MySQLProfile.backend.DatabaseDef   = ??? /// globalDatabaseManager.getDbForProject(project).master
