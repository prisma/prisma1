...
class NestedSetMutationInsideUpdateSpec extends FlatSpec with Matchers with ApiSpecBase with SchemaBase {
  override def runOnlyForCapabilities: Set[ConnectorCapability] = Set(JoinRelationLinksCapability)

  "a P1! to C1! relation with the child already in a relation" should "error when setting by id since old required parent relation would be broken" in {
  ...
  "a P1! to C1  relation with the child not in a relation" should "be setable through a nested mutation by id" in {
    val project = SchemaDsl.fromString() { schemaP1reqToC1opt }
    database.setup(project)
  ...
  "a P1 to C1  relation with the child already in a relation" should "be setable through a nested mutation by id if the child is already in a relation" in {
  ...
  "a P1 to C1  relation with the child and the parent without a relation" should "be setable through a nested mutation by id" in {
    val project = SchemaDsl.fromString() { schemaP1optToC1opt }
    database.setup(project)
  ...
  "a P1 to C1  relation with the child without a relation" should "be setable through a nested mutation by id" in {
    val project = SchemaDsl.fromString() { schemaP1optToC1opt }
    database.setup(project)
  ...
  "a P1 to C1  relation with the parent without a relation" should "be setable through a nested mutation by id" in {
    val project = SchemaDsl.fromString() { schemaP1optToC1opt }
    database.setup(project)
  ...
  "a P1 to C1!  relation with the child and the parent already in a relation" should "should error in a set by unique" in {
  ...
  "a P1! to CM  relation with the child already in a relation" should "be setable through a nested mutation by unique" in {
  ...
  "a P1! to CM  relation with the child not already in a relation" should "be setable through a nested mutation by unique" in {
    val project = SchemaDsl.fromString() { schemaP1reqToCM }
    database.setup(project)
  ...
  "a one to many relation" should "be setable by any unique argument through a nested mutation" in {
    val project = SchemaDsl.fromString() {
      """type Comment {
        | id: ID! @unique
        | text: String
  ...
  "a one to many relation" should "be setable by id through a nested mutation 2" in {
    val project = SchemaDsl.fromString() {
      """type Comment {
        | id: ID! @unique
        | text: String
  ...
  "a one to one relation" should "be setable by id through a nested mutation" in {
    val project = SchemaDsl.fromString() {
      """type Note {
        | id: ID! @unique
        | text: String
