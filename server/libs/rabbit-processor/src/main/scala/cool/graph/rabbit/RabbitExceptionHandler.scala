...
case class RabbitExceptionHandler(reporter: ErrorReporter) extends DefaultExceptionHandler {

  override def handleConsumerException(
    ...
    reporter.report(new RuntimeException("Rabbit error occurred. -> handleConsumerException", exception))
    super.handleConsumerException(channel, exception, consumer, consumerTag, methodName)
  }

  override def handleUnexpectedConnectionDriverException(conn: Connection, exception: Throwable): Unit = {
    reporter.report(new RuntimeException("Rabbit error occurred. -> handleUnexpectedConnectionDriverException", exception))
  ...
  override def handleBlockedListenerException(connection: Connection, exception: Throwable): Unit = {
    reporter.report(new RuntimeException("Rabbit error occurred. -> handleBlockedListenerException", exception))
  ...
  override def handleChannelRecoveryException(ch: RabbitChannel, exception: Throwable): Unit = {
    reporter.report(new RuntimeException("Rabbit error occurred. -> handleChannelRecoveryException", exception))
  ...
  override def handleFlowListenerException(channel: RabbitChannel, exception: Throwable): Unit = {
    reporter.report(new RuntimeException("Rabbit error occurred. -> handleFlowListenerException", exception))
  ...
  override def handleReturnListenerException(channel: RabbitChannel, exception: Throwable): Unit = {
    reporter.report(new RuntimeException("Rabbit error occurred. -> handleReturnListenerException", exception))
  ...
  override def handleTopologyRecoveryException(conn: Connection, ch: RabbitChannel, exception: TopologyRecoveryException): Unit = {
    reporter.report(new RuntimeException("Rabbit error occurred. -> handleTopologyRecoveryException", exception))
  ...
  override def handleConfirmListenerException(channel: RabbitChannel, exception: Throwable): Unit = {
    reporter.report(new RuntimeException("Rabbit error occurred. -> handleConfirmListenerException", exception))
  ...
  override def handleConnectionRecoveryException(conn: Connection, exception: Throwable): Unit = {
    reporter.report(new RuntimeException("Rabbit error occurred. -> handleConnectionRecoveryException", exception))
  ...
  override def handleChannelKiller(channel: RabbitChannel, exception: Throwable, what: String): Unit = {
    reporter.report(new RuntimeException("Rabbit error occurred. -> handleChannelKiller", exception))
  ...
  override def handleConnectionKiller(connection: Connection, exception: Throwable, what: String): Unit = {
    reporter.report(new RuntimeException("Rabbit error occurred. -> handleConnectionKiller", exception))
