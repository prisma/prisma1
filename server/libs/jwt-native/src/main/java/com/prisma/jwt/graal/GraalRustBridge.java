...
public class GraalRustBridge {
    ...
    @CFunction
    static native CIntegration.ProtocolBuffer verify_token(CCharPointer algorithm, CCharPointer secrets, long num_secrets, CCharPointer expect_target, CCharPointer expect_action);
