...
//object ScalarField{
//  def dummy(name: String, typeIdentifier: TypeIdentifier.ScalarTypeIdentifier, isList: Boolean): ScalarField = ScalarField(name, typeIdentifier, isRequired = false, isList= isList, isUnique = false, isHidden = false, isReadonly = false, isAutoGenerated = false, enum=None, defaultValue =None, manifestation =  = None,  )
//
//
//}
