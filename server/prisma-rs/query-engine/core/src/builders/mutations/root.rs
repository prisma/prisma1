...
impl<'field> MutationBuilder<'field> {
    ...
    pub fn build(self) -> CoreResult<MutationSet> {
...
fn handle_reset(field: &Field, internal_data_model: InternalDataModelRef) -> CoreResult<MutationSet> {
    Ok(MutationSet::Query(WriteQuery {
