...
pub fn render_mcf_to_json_value(mcf: &Configuration) -> serde_json::Value {
    serde_json::to_value(&to_serializeable(mcf)).expect("Failed to render JSON.")
}

pub fn render_mcf_to_json(mcf: &Configuration) -> String {
    serde_json::to_string(&to_serializeable(mcf)).expect("Failed to render JSON.")
}

pub fn mcf_from_json(json: &str) -> Configuration {
...
pub fn mcf_from_json_value(json: serde_json::Value) -> Configuration {
...
pub fn mcf_from_json_value_with_plugins(
